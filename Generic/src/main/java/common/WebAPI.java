...
public class WebAPI {
    ...
    public void setUp(@Optional("false") boolean useCloudEnv, @Optional("false") String cloudEnvName,
                      @Optional("windows") String os, @Optional("10") String os_version, @Optional("chrome-options") String browserName, @Optional("79")
    ...
    public WebDriver getLocalDriver(   @Optional("windows")    String OS, String browserName) {
     ...
     //       options.addArguments("--disable-notifications");
            if (OS.equalsIgnoreCase("OS X")) {
                ...
                System.setProperty("webdriver.chrome.driver", "C:\\Users\\naser\\IdeaProjects\\Team-1_WebAutomationFramework\\Generic\\BrowserDriver\\Windows\\chromedriver.exe");
            }
